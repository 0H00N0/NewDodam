...
@RestController @RequestMapping("/faqs") @RequiredArgsConstructor public class FaqController {
  ...
  @GetMapping public Page<FaqResponse> list(@RequestParam String code, @RequestParam(required=false) String category, Pageable p){ return svc.list(code, category, p); }
