...
public class AdminEventController {
    ...
    /** 이벤트 수정 */
    @PutMapping("/{evNum}")
    public ResponseEntity<EventResponseDTO> updateEvent(@PathVariable("evNum") Long evNum, @RequestBody EventRequestDTO dto) {
    ...
    public ResponseEntity<ApiResponseDTO> handleGlobalException(Exception ex) {
        return new ResponseEntity<>(new ApiResponseDTO(false, "서버 오류 발생: " + ex.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
}